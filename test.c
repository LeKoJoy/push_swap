...
int	main(int nn, char **s)
{
	...
	int n = 2;
	// 50
	//char *s[2] = {"name", "19 33 23 8 31 24 22 13 50 48 5 3 36 43 37 49 7 21 25 2 9 45 46 30 16 41 20 40 18 10 29 42 17 27 15 47 38 44 12 11 28 1 39 34 26 6 4 32 35 14"};
